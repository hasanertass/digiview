<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="{{ route('merchant.show', ['merchant' => $merchant->url]) }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('bankinfo.show', ['bankinfo' => $merchant->url]) }}">
                    ...
                    <span class="nav-link-text ms-1">Banka Bilgileri / Kataloglar</span>
                </a>
            </li>
        </ul>
    </div>
