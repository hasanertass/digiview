                            ...
                            <div class="card-body">
                                ...
                                <form role="form" class="text-start" action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="form-check form-switch d-flex align-items-center mb-3">
                                        ...
                                        <label class="form-check-label mb-0 ms-3" for="rememberMe" id="rememberme" name="rememberme">Remember me</label>
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" class="btn w-100 my-4 mb-2" style="background-color:#0c2a6d; color: #00a01d">Giriş Yap</button>
                                    </div>
                                </form>
                            </div>
                        </div>
