        ...
        <div class="container opened" data-animation-in="fadeInLeft" data-animation-out="fadeOutLeft">
            ...
            <header class="header">
                ...
                <div class="profile">
                    ...
                    <div class="title">Ryan Adlard Hasan</div>
            ...
            <div class="card-started" id="home-card">
                ...
                <div class="profile">
                    ...
                    <!-- profile photo -->
                    <div class="image">
                        <img src="{{  asset($personinfo->photograph) }}" alt="" />
                    </div>
                    <br>
                    <!-- profile titles -->
                    <div class="title">{{$merchant->name}} {{$merchant->surname}}</div>
            ...
            <!--
				Card - About
			-->
            @include('ui_panel.tema_two.contents.person_info')
